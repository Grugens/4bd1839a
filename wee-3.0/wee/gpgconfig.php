<?php
 ...
 // version 3.0
    ...
    // Encryption
    $REPLACEFILE = "yes";
    $DATADIR = "/path/to/your/owncloud/data";
    $ENCRYPTIONTEXTAREA = "demotext"; 
    $INPUT = "textarea";
    $INPUTNAME = "demotext";
    //$INPUT = "iframe";
    //$IFRAMENUMBER = 1;
    ...
    //$DECRYPTIONINPUT = "file";
    //$DECRYPTIONINPUT = "iframe";
    //$DECRYPTIONIFRAMENUMBER = 1;
    $DECRYPTIONINPUTNAME = "sentmessage";
    //$DECRYPTIONINPUTID = "messagebody";
    ...
    //$SIGINPUTID = "ComposeMsgText";
    $SIGTEXTAREA = "demotext"; 

    // Verification
    $VERIFYINPUT = "textarea";
    //$VERIFYINPUT = "iframe";
    //$VERIFYIFRAMENUMBER = 1;
    $VERIFYINPUTNAME = "sentmessage";
    //$VERIFYINPUTID = "messagebody";
